...
export default function Slide02ProblemaCliente() {
  const notas = [
    ...
    { icon: (<svg width="44" height="44" viewBox="0 0 24 24" fill="none" stroke="#A2003C" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>), border: '#A2003C', title: 'Órdenes ineficientes', point: 'Dificultad e ineficiencia para órdenes simples' },
    { icon: (<svg width="44" height="44" viewBox="0 0 24 24" fill="none" stroke="#333" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="5" width="20" height="14" rx="2"/><line x1="2" y1="10" x2="22" y2="10"/></svg>), border: '#333333', title: 'Fragmentación de pago', point: 'Al realizar el pago habían muchos métodos distintos' },
